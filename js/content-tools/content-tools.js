...
(function() {
  ...
  ContentEdit.ElementCollection = (function(_super) {
    ...
    ElementCollection.prototype.html = function(indent) {
      ...
      children = (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          c = _ref[_i];
          var t = c.html(indent + ContentEdit.INDENT);
          console.log(t);
          _results.push(t);
        }
        return _results;
  ...
  ContentEdit.TagNames.get().register(ContentEdit.Text, 'address', 'blockquote', 'h1', 'h2', 'h3', 'h4', 'h5', 'h6', 'p', 'x-dynamic');
...
(function() {
  ...
  ContentTools = {
    ...
    DEFAULT_TOOLS: [['bold', 'italic', 'link', 'align-left', 'align-center', 'align-right'], ['heading', 'subheading', 'paragraph', 'dynamic', 'unordered-list', 'ordered-list', 'table', 'indent', 'unindent', 'line-break'], ['image', 'video', 'preformatted'], ['undo', 'redo', 'remove']],
  ...
  ContentTools.Tools.Paragraph = (function(_super) {
    ...
    /*DIV*/
    ContentTools.Tools.Dynamic = (function(_super) {
        ...
        ContentTools.ToolShelf.stow(Dynamic, 'dynamic');

        Dynamic.label = 'Dynamic contemt';

        Dynamic.icon = 'dynamic';

        Dynamic.tagName = 'x-dynamic';

        Dynamic.canApply = function(element, selection) {
            if (element.isFixed()) {
                return false;
            }
            return element !== void 0;
        ...
        Dynamic.apply = function(element, selection, callback) {
            var forceAdd, paragraph, region, toolDetail;
            forceAdd = this.editor().ctrlDown();
            if (ContentTools.Tools.Heading.canApply(element) && !forceAdd) {
                return Dynamic.__super__.constructor.apply.call(this, element, selection, callback);
            } else {
                toolDetail = {
                    'tool': this,
                    'element': element,
                ...
                region = element.parent();
                paragraph = new ContentEdit.Text('x-dynamic');
                region.attach(paragraph, region.children.indexOf(element) + 1);
                paragraph.focus();
                callback(true);
                return this.dispatchEditorEvent('tool-applied', toolDetail);
